            ...
            <div className="card-body card-body-padding d-flex align-items-center justify-content-between">
              <div className="ps-lg-1">
                <div className="d-flex align-items-center justify-content-between">
                  ...
                  <a href="https://www.bootstrapdash.com/product/corona-react/?utm_source=navbar&utm_medium=productdemo&utm_campaign=getpro" target="_blank" rel="noopener noreferrer" className="btn mr-2 buy-now-btn border-0">Buy Now</a>
                </div>
              </div>
              <div className="d-flex align-items-center justify-content-between">
                <a href="https://www.bootstrapdash.com/product/corona-react/"><i className="mdi mdi-home mr-3 text-white"></i></a>
                <button id="bannerClose" className="btn border-0 p-0" onClick={this.toggleProBanner}>
